...
(1, 'DAX', 'Deutscher Aktienindex', 22105.37, 21697.30),
(2, 'DHL', 'Deutsche Post DHL Group', 38.57, 38.82),
(3, 'LHA', 'Lufthansa AG', 8.16, 8.05),
(4, 'SAP', 'SAP SE', 167.95, 165.76),
(5, 'BMW', 'Bayerische Motoren Werke AG', 90.06, 92.67);
...
--
ALTER TABLE `benutzer`
  MODIFY `BenutzerID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `konto`
  MODIFY `KontoID` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `kredite`
--
ALTER TABLE `kredite`
  MODIFY `KreditID` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `logininfo`
--
ALTER TABLE `logininfo`
  MODIFY `LoginID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
